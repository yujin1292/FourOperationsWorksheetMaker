...
public class Main extends JFrame implements ActionListener{
    ...
    private  JLabel text1 = new JLabel("OPERATOR");
    ...
    Main() {
        ...
        operator.add(AddButton);
        operator.add(subButton);
        operator.add(multiplyButton);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if( e.getSource().equals(AddButton)){
            create = new CreateAddition(opnd1.getSelectedIndex()+1,opnd2.getSelectedIndex()+1 ,
                    page.getSelectedIndex()+1);
        }
        else if( e.getSource().equals(subButton)){
            create = new CreateSubtraction(opnd1.getSelectedIndex()+1,opnd2.getSelectedIndex()+1,
                    page.getSelectedIndex()+1 );

        }
        else if( e.getSource().equals(multiplyButton)){
            create = new CreateMultiply(opnd1.getSelectedIndex()+1,opnd2.getSelectedIndex()+1,
                    page.getSelectedIndex()+1);
        }
